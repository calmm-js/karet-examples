...
export const bmi = ({height, weight}) => Math.round(weight/(height * height * 0.0001))

export const classification = bmi =>
...
export const BMI = {
  augment: L.augment({bmi}),
  bmi: R.prop("bmi"),
  height: "height",
  weight: "weight",
  classification: ({bmi}) => classification(bmi)
}
